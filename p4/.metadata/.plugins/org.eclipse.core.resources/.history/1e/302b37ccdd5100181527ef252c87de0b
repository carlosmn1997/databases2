...
public class OperacionEntity {
    ...
    private CuentaEntity cuentaByIbanorigen;
    private CuentaEntity cuentaByIbandestino;
    ...
    @ManyToOne
    @JoinColumn(name = "IBANORIGEN", referencedColumnName = "IBAN", nullable = false)
    public CuentaEntity getCuentaByIbanorigen() {
        return cuentaByIbanorigen;
    }

    public void setCuentaByIbanorigen(CuentaEntity cuentaByIbanorigen) {
        this.cuentaByIbanorigen = cuentaByIbanorigen;
    }

    @ManyToOne
    @JoinColumn(name = "IBANDESTINO", referencedColumnName = "IBAN")
    public CuentaEntity getCuentaByIbandestino() {
        return cuentaByIbandestino;
    }

    public void setCuentaByIbandestino(CuentaEntity cuentaByIbandestino) {
