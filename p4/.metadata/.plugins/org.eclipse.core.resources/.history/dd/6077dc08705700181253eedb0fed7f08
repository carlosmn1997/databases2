...
//    @ElementCollection(targetClass=Ingreso.class)
//	private Set<Ingreso> ingreso;// = new HashSet<IngresoRetirada>();
//
//	public Set<Ingreso> getIngreso() {
//		return ingreso;
//	}
//
//	public void setIngreso(Set<Ingreso> ingreso) {
